package org.udoo.clientcameraoverlayservice.joystick;
...
public class JoystickView extends View {
        ...
        //Cartesian coordinates of last touch point - joystickSX center is (0,0)
        private int cartX, cartY;
        
        //Polar coordinates of the touch point from joystickSX center
        ...
        //Offset co-ordinates (used when touch events are received from parent'datagramSocket coordinate origin)
        private int offsetX;
        private int offsetY;
        ...
        protected void onDraw(Canvas canvas) {
                ...
                if (D) {
                        ...
                        canvas.drawText(String.format("%datagramSocket (%.0f,%.0f)", TAG, touchX, touchY), handleX-20, baseY-7, dbgPaint2);
